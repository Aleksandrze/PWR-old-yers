...
#S?owo ma 4 bajty
# 1 bit = 8 bajtow
# $at register ktory jest zarezerwowany assembblere
.data
myArray: .space 28 # 40 bajtow to 10 liczb typu int ktory mozem tutaj zmiescic (data segment)
newLine:.asciiz","
...
inputArray:
	...
	li $t1, 28 	#odczyt 40 w rejester $t1 ( rejestr wartosci funkcji)
